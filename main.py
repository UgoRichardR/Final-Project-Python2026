...
newsScreen = tk.Frame(root, bg="red", width=WIDTH, height=HEIGHT)
...
newsBtn = tk.Button(inner_frame, text="News", command=openNewsScreen)
...
#region ================== HOVER SCALE ==================
def add_dock_hover(button, base_size=10, max_size=16):
...
toggle_btn = tk.Button(root, text="Toggle Taskbar", bg="#222", fg="white")
